...
export default function Navbar(props) {
    ...
    const buttonStyle = {width: "3.5rem", height: "3.5rem", minWidth: "unset", backgroundRepeat: "no-repeat", backgroundSize: "50%", backgroundPosition: "center", margin: "1rem 0rem 1rem 0rem"};
